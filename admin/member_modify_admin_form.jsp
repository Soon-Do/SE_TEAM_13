...
<jsp:useBean id="membermanager" class="member.Manager"/>
<%
...
<html>
  <head>
    <meta charset="UTF-8">
      <title>MMAF</title>
      <script src="../js/javascript.js?ver=2"></script>
      ...
      window.onload = function(){
        ...
        document.getElementsById("btnModify").onclick = admin_modify_member_action;
        document.getElementsById("btnModifyCancel").onclick = admin_modify_member_cancel;
        document.getElementsById("btnDelete").onclick = function(){
        ...
        <td align="center" valign="middle" style="background-color: #FFFFCC">
          <form name="modifyFormAdmin" method="post" action=member_modify_admin_action.jsp>
            <table border="1">
              ...
              <tr>
                <td>우편번호</td>
                <td><input type="text" name="zipcode" size="7" value"<%=dto.getAddress() %>"></td>
              </tr>
              <tr>
                <td>직업</td>
